...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.payment_type'
        db.add_column(u'reg_sale', 'payment_type',
                      self.gf('django.db.models.fields.CharField')(default='online_credit', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.payment_type'
        db.delete_column(u'reg_sale', 'payment_type')
    ...
    models = {
        ...
        u'reg.sale': {
            ...
            'payment_type': ('django.db.models.fields.CharField', [], {'default': "'online_credit'", 'max_length': '255', 'blank': 'True'}),
