...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CouponCode.max_tickets'
        db.alter_column(u'reg_couponcode', 'max_tickets', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'CouponCode.max_tickets'
        db.alter_column(u'reg_couponcode', 'max_tickets', self.gf('django.db.models.fields.PositiveIntegerField')())
