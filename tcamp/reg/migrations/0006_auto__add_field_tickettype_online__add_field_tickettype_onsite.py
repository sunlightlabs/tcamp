...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketType.online'
        db.add_column(u'reg_tickettype', 'online',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'TicketType.onsite'
        db.add_column(u'reg_tickettype', 'onsite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketType.online'
        db.delete_column(u'reg_tickettype', 'online')

        # Deleting field 'TicketType.onsite'
        db.delete_column(u'reg_tickettype', 'onsite')
