...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'pages_page', 'js')

        # Deleting field 'Page.css'
        db.delete_column(u'pages_page', 'css')


    def backwards(self, orm):
        # Adding field 'Page.js'
        db.add_column(u'pages_page', 'js',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Page.css'
        db.add_column(u'pages_page', 'css',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'pages.block': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blocks'", 'to': u"orm['pages.Page']"})
        },
        u'pages.chunk': {
        ...
        u'pages.page': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages'", 'to': u"orm['pages.Template']"}),
