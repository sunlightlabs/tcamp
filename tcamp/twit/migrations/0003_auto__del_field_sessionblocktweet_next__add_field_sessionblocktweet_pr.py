...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SessionBlockTweet.previous'
        db.add_column(u'twit_sessionblocktweet', 'previous',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='next', unique=True, null=True, to=orm['twit.SessionBlockTweet']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SessionBlockTweet.next'
        db.add_column(u'twit_sessionblocktweet', 'next',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='previous', unique=True, null=True, to=orm['twit.SessionBlockTweet'], blank=True),
                      keep_default=False)

        # Deleting field 'SessionBlockTweet.previous'
        db.delete_column(u'twit_sessionblocktweet', 'previous_id')
