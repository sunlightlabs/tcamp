...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'twit_sessionblocktweet', 'sent_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'SessionBlockTweet.sent_at'
        db.alter_column(u'twit_sessionblocktweet', 'sent_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
