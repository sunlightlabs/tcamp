...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionBlockTweet.session_ids'
        db.add_column(u'twit_sessionblocktweet', 'session_ids',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=128, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SessionBlockTweet.session_ids'
        db.delete_column(u'twit_sessionblocktweet', 'session_ids')
