...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SponsorshipLevel.price'
        db.alter_column(u'camp_sponsorshiplevel', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'SponsorshipLevel.price'
        db.alter_column(u'camp_sponsorshiplevel', 'price', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'camp.sponsorshiplevel': {
            'Meta': {'ordering': "('-order', '-price')", 'object_name': 'SponsorshipLevel'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
