...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsorshipLevel.event'
        db.add_column(u'camp_sponsorshiplevel', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sponsorship_levels', to=orm['sked.Event']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SponsorshipLevel.event'
        db.delete_column(u'camp_sponsorshiplevel', 'event_id')
        ...
        # User chose to not deal with backwards NULL issues for 'Sponsor.event'
        raise RuntimeError("Cannot reverse this migration. 'Sponsor.event' and its values cannot be restored.")
    ...
    models = {
        ...
        u'camp.sponsorshiplevel': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sponsorship_levels'", 'to': u"orm['sked.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
