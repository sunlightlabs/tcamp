...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.session_submission_is_open'
        db.add_column(u'sked_event', 'session_submission_is_open',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.session_submission_is_open'
        db.delete_column(u'sked_event', 'session_submission_is_open')
