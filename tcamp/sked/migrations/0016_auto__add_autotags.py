...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AutoTags'
        db.create_table(u'sked_autotags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sked_autotags_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sked.Session'])),
        ))
        db.send_create_signal(u'sked', ['AutoTags'])


    def backwards(self, orm):
        # Deleting model 'AutoTags'
        db.delete_table(u'sked_autotags')
