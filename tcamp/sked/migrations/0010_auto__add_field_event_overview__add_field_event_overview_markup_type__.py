...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.overview'
        db.add_column(u'sked_event', 'overview',
                      self.gf('markupfield.fields.MarkupField')(default='', rendered_field=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.overview_markup_type'
        db.add_column(u'sked_event', 'overview_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Event._overview_rendered'
        db.add_column(u'sked_event', '_overview_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.overview'
        db.delete_column(u'sked_event', 'overview')

        # Deleting field 'Event.overview_markup_type'
        db.delete_column(u'sked_event', 'overview_markup_type')

        # Deleting field 'Event._overview_rendered'
        db.delete_column(u'sked_event', '_overview_rendered')
