...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.session_length'
        db.add_column(u'sked_event', 'session_length',
                      self.gf('timedelta.fields.TimedeltaField')(default='1 hour'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.session_length'
        db.delete_column(u'sked_event', 'session_length')
