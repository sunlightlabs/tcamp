...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sked_session', 'title', self.gf('django.db.models.fields.CharField')(max_length=102))

    def backwards(self, orm):

        # Changing field 'Session.title'
        db.alter_column(u'sked_session', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))
