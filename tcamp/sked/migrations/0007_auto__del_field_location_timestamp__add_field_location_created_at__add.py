...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'sked_location', 'timestamp')

        # Adding field 'Location.created_at'
        db.add_column(u'sked_location', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Location.updated_at'
        db.add_column(u'sked_location', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Location.timestamp'
        db.add_column(u'sked_location', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 15, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Location.created_at'
        db.delete_column(u'sked_location', 'created_at')

        # Deleting field 'Location.updated_at'
        db.delete_column(u'sked_location', 'updated_at')
