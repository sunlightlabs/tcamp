...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sked_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', to=orm['sked.Event'])),
            ('is_official', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'sked', ['Location'])

        # Deleting field 'Session.location'
        db.delete_column(u'sked_session', 'location')


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'sked_location')

        # Adding field 'Session.location'
        db.add_column(u'sked_session', 'location',
