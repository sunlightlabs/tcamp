...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sked_sentemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipients', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('sender', self.gf('django.db.models.fields.EmailField')(max_length=127)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sked.Session'])),
            ('sent_at', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'sked', ['SentEmail'])


    def backwards(self, orm):
        # Deleting model 'SentEmail'
        db.delete_table(u'sked_sentemail')
    ...
    models = {
        ...
        u'sked.sentemail': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sked.Session']"}),
