...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.description_markup_type'
        db.add_column(u'sked_session', 'description_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Session._description_rendered'
        db.add_column(u'sked_session', '_description_rendered',
                      self.gf('django.db.models.fields.TextField')(default=u''),
                      keep_default=False)


        # Changing field 'Session.description'
        db.alter_column(u'sked_session', 'description', self.gf('markupfield.fields.MarkupField')(rendered_field=True))
        # Adding field 'Event.description'
        db.add_column(u'sked_event', 'description',
                      self.gf('markupfield.fields.MarkupField')(default='', rendered_field=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.description_markup_type'
        db.add_column(u'sked_event', 'description_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Event._description_rendered'
        db.add_column(u'sked_event', '_description_rendered',
                      self.gf('django.db.models.fields.TextField')(default=u''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.description_markup_type'
        db.delete_column(u'sked_session', 'description_markup_type')

        # Deleting field 'Session._description_rendered'
        db.delete_column(u'sked_session', '_description_rendered')


        # Changing field 'Session.description'
        db.alter_column(u'sked_session', 'description', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Event.description'
        db.delete_column(u'sked_event', 'description')

        # Deleting field 'Event.description_markup_type'
        db.delete_column(u'sked_event', 'description_markup_type')

        # Deleting field 'Event._description_rendered'
        db.delete_column(u'sked_event', '_description_rendered')
