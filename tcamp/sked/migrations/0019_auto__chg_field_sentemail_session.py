...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SentEmail.session'
        db.alter_column(u'sked_sentemail', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sked.Session'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'SentEmail.session'
        db.alter_column(u'sked_sentemail', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['sked.Session']))
